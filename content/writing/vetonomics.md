...
{{% sidenote %}}
A **principal–agent problem** arises when one party (the _principal_) delegates decision-making authority to another (the _agent_), whose actions affect the principal’s welfare, but whose incentives are not perfectly aligned and whose behaviour cannot be fully observed.
